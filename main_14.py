...
from model_structure14 import newbob, Fusion, LHS, RHS_train
...
# Start a W&B run
wandb.init(project="sess_5_setup_RHS", entity="natascha-msc-project", config=config)
...
model = RHS_train(roberta, speechBert, freeze_models=config["freeze_models"]).to(device)
