...
JUST FOR ABLATION STUDIES: RHS + Roberta OR Speech BERT
...
from model_structure16 import newbob, Fusion, SpeechBert_RHS
...
# Start a W&B run
wandb.init(project="sess_5_setup_RHS_SpeechBert", entity="natascha-msc-project", config=config)
...
model = SpeechBert_RHS(roberta, speechBert, freeze_models=config["freeze_models"]).to(device)
