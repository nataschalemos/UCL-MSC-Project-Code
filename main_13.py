...
JUST FOR ABLATION STUDIES: LHS vs RHS
...
from model_structure13 import newbob, Fusion, LHS, LHS_train
...
# Start a W&B run
wandb.init(project="sess_5_setup_LHS", entity="natascha-msc-project", config=config)
...
model = LHS_train(roberta, speechBert, freeze_models=config["freeze_models"]).to(device)
