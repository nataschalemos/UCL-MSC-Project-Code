...
class IemocapDataset(Dataset):
    ...
    def __init__(self, labels_file, wdir, max_text_tokens=512, max_audio_tokens=512, transform=None):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        SpeechBERT_tks_file_name = os.path.join(self.wdir + 'IEMOCAP/' + 'vqw2vTokens', file_name + '.txt')
        Roberta_tks_file_name = os.path.join(self.wdir + 'IEMOCAP/' + 'GPT2Tokens', file_name + '.pkl')
        TAB_emb_file_name = os.path.join(self.wdir + 'IEMOCAP/' + 'FullBertEmb', file_name + '.txt')
