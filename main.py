...
labels_file = wdir + 'IEMOCAP/' + 'labels_train_t.txt'

# Define path to directory with TSB and TAB input embeddings
root_dir_Roberta = wdir + 'IEMOCAP/GPT2Tokens'
root_dir_SpeechBERT = wdir + 'IEMOCAP/vqw2vTokens'
root_dir_TAB = wdir + 'IEMOCAP/FullBertEmb'
root_dir_text = wdir + 'IEMOCAP/Text'
root_dir_audio = wdir + 'IEMOCAP/Audio'
...
print('Saving model...')
torch.save(model.state_dict(), wdir + 'IEMOCAP/' + "outputs/model.pth")
