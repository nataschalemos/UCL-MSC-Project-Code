...
from model_structure15 import newbob, Fusion, Roberta_RHS
...
# Start a W&B run
wandb.init(project="sess_5_setup_RHS_Roberta", entity="natascha-msc-project", config=config)
...
model = Roberta_RHS(roberta, speechBert, freeze_models=config["freeze_models"]).to(device)
