...
optimizer = 'Adadelta'
code_path = "/Volumes/TOSHIBA EXT/Code/IEMOCAP/IEMOCAP_full_release"
...
def read_iemocap_mocap():
    ...
    for session in sessions:
        ...
        for f in files:
            ...
            ex_num_a = split_wav(wav, emotions, ex_num_a, session[-1])
            ex_num_t = split_text(transcriptions, emotions, ex_num_t, session[-1]) ## ADDED session #############
